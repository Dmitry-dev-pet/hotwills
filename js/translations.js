...
const TRANSLATIONS = {
  ru: {
    ...
    linkWord: 'ССЫЛКА',
    pageTitle: 'Каталог',
    headerSubtitle: 'Каталог, инфографика и статистика коллекции',
    statsOpen: 'Статистика',
    headerMetricModels: 'Моделей: {n}',
    headerMetricCodes: 'Кодов: {n}',
    headerMetricYears: 'Годы: {years}',
    headerMetricSimilar: 'У других: {n}',
    ...
    statsSectionCollection: 'Состав каталога',
    statsSectionSocial: 'Сравнение',
    statsTotalModels: 'Всего моделей',
    statsUniqueCodes: 'Уникальных кодов',
    statsYearRange: 'Диапазон лет',
    statsFavorites: 'В избранном',
    statsAlsoInOthers: 'Кодов у других',
    statsModelsWithOthers: 'Моделей с совпадениями',
    statsTopCodes: 'Топ кодов',
    statsDecades: 'Распределение по десятилетиям',
    statsDuplicates: 'Дубликаты по коду',
    statsDataQuality: 'Качество данных',
    statsMissingLinks: 'Без ссылки',
    statsMissingImages: 'Без изображения',
    statsCompareWith: 'Сравнить с пользователем',
    statsCompareApply: 'Сравнить',
    statsSharedCodes: 'Общие коды',
    statsSharedPercent: 'Совпадение, %',
    statsOnlyMine: 'Только у меня',
    statsOnlyOther: 'Только у другого',
    statsTopSharedCodes: 'Топ общих кодов',
    statsNoData: 'Нет данных',
    statsNoDuplicates: 'Дубликатов нет',
    statsNoDecades: 'Года не определены',
    statsNoSharedCodes: 'Нет общих кодов',
  ...
  en: {
    ...
    linkWord: 'LINK',
    pageTitle: 'Catalog',
    headerSubtitle: 'Catalog, infographic, and collection statistics',
    statsOpen: 'Statistics',
    headerMetricModels: 'Models: {n}',
    headerMetricCodes: 'Codes: {n}',
    headerMetricYears: 'Years: {years}',
    headerMetricSimilar: 'In others: {n}',
    ...
    statsTitle: 'Catalog statistics',
    statsSectionOverview: 'Overview',
    statsSectionCollection: 'Catalog composition',
    statsSectionSocial: 'Comparison',
    statsTotalModels: 'Total models',
    statsUniqueCodes: 'Unique codes',
    statsYearRange: 'Year range',
    statsFavorites: 'Favorites',
    statsAlsoInOthers: 'Codes in other catalogs',
    statsModelsWithOthers: 'Models with matches',
    statsTopCodes: 'Top codes',
    statsDecades: 'By decade',
    statsDuplicates: 'Duplicate codes',
    statsDataQuality: 'Data quality',
    statsMissingLinks: 'Missing link',
    statsMissingImages: 'Missing image',
    statsCompareWith: 'Compare with user',
    statsCompareApply: 'Compare',
    statsSharedCodes: 'Shared codes',
    statsSharedPercent: 'Match, %',
    statsOnlyMine: 'Only mine',
    statsOnlyOther: 'Only other',
    statsTopSharedCodes: 'Top shared codes',
    statsNoData: 'No data',
    statsNoDuplicates: 'No duplicates',
    statsNoDecades: 'No year data',
    statsNoSharedCodes: 'No shared codes',
  ...
  pt: {
    ...
    linkWord: 'LINK',
    pageTitle: 'Catálogo',
    headerSubtitle: 'Catalogo, infografico e estatisticas da colecao',
    statsOpen: 'Estatisticas',
    headerMetricModels: 'Modelos: {n}',
    headerMetricCodes: 'Codigos: {n}',
    headerMetricYears: 'Anos: {years}',
    headerMetricSimilar: 'Em outros: {n}',
    ...
    statsTitle: 'Estatisticas do catalogo',
    statsSectionOverview: 'Visao geral',
    statsSectionCollection: 'Composicao do catalogo',
    statsSectionSocial: 'Comparacao',
    statsTotalModels: 'Total de modelos',
    statsUniqueCodes: 'Codigos unicos',
    statsYearRange: 'Faixa de anos',
    statsFavorites: 'Favoritos',
    statsAlsoInOthers: 'Codigos em outros catalogos',
    statsModelsWithOthers: 'Modelos com correspondencia',
    statsTopCodes: 'Top codigos',
    statsDecades: 'Por decada',
    statsDuplicates: 'Codigos duplicados',
    statsDataQuality: 'Qualidade dos dados',
    statsMissingLinks: 'Sem link',
    statsMissingImages: 'Sem imagem',
    statsCompareWith: 'Comparar com usuario',
    statsCompareApply: 'Comparar',
    statsSharedCodes: 'Codigos compartilhados',
    statsSharedPercent: 'Correspondencia, %',
    statsOnlyMine: 'Apenas meus',
    statsOnlyOther: 'Apenas do outro',
    statsTopSharedCodes: 'Top codigos compartilhados',
    statsNoData: 'Sem dados',
    statsNoDuplicates: 'Sem duplicados',
    statsNoDecades: 'Sem dados de ano',
    statsNoSharedCodes: 'Sem codigos compartilhados',
