...
const TRANSLATIONS = {
  ru: {
    ...
    modelYearsTitle: 'Годы модели: {model}',
    modelYearsEmpty: 'Нет годов в диапазоне 1950-1999',
  ...
  en: {
    ...
    modelYearsTitle: 'Years for {model}',
    modelYearsEmpty: 'No years in 1950-1999 range',
  ...
  pt: {
    ...
    modelYearsTitle: 'Anos do modelo: {model}',
    modelYearsEmpty: 'Sem anos no intervalo 1950-1999',
